...
class AverageLog:
    ...
    def resolve_inconsistencies(cls, df_data, inconsistencies, answers=None):
        ...
        Inputs:
            df_data: (pd.DataFrame) Integrated data that needs inconsistencies resolved.
        ...
        Returns:
            ...
            df_belief_and_source_without_inconsistencies: (pd.DataFrame) Belief
                vector and df_grouped_data concatenated but without the inconsistencies.
        ...
        # initialize
        np_present_belief_vector = Sums.initialize_belief(df_grouped_data)
    ...
    def create_matrices(df_grouped_data, df_source_size_data):
        ...
        source_sizes = np.array(df_source_size_data)
