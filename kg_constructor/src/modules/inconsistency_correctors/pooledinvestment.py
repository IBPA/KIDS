...
class PooledInvestment:
    ...
    """
    @classmethod
    def resolve_inconsistencies(cls, df_data, inconsistencies, answers=None, exponent=1.4):
        """
        ...
        np_present_belief_vector = Investment.initialize_belief(
            df_source_size_data, df_grouped_data, inconsistencies)
        np_past_trustworthiness_vector = Investment.initialize_trustworthiness(df_source_size_data)
        np_default_a_matrix, np_b_matrix = Investment.create_matrices(
            df_grouped_data, df_source_size_data)
        ...
        while delta > THRESHOLD and iteration < MAX_NUM_ITERATIONS:
            ...
            claims = df_grouped_data.index.tolist()
